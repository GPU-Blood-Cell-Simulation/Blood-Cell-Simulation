...
inline constexpr float particle_k_sniff = 0.002f;// 0.2f;// 0.000002f;
inline constexpr float vein_k_sniff = 0.03f;

// ! this value should be determined experimentally !
// Damping factor 
inline constexpr float particle_d_fact = 0;//0.999f;/////0.3f;
inline constexpr float vein_d_fact = 0;

// Particle-particle collision coefficients
inline constexpr float collisionSpringCoeff = 0.002f;// 0.2f;
